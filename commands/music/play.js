                ...
                if (serverQueue) {
                    ...
                    if (playlist) return undefined;
                        ...
                        const sembed = new MessageEmbed()
                            ...
                            .setAuthor("Added To Queue"  ,message.member.displayName, message.author.displayAvatarURL())
                            .addField("Song Duration", + `${song.duration}/60`, false)
                            .setFooter(`Requested By **${message.author.username}`, message.member.displayName, message.author.displayAvatarURL());
